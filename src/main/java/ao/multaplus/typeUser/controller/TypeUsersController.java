...
public class TypeUsersController {
    ...
    @PostMapping
    public ResponseEntity<TypeUsersResponsedtos> create(@RequestBody @Valid TypeUsersRequestdtos request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TypeUsersResponsedtos> getById(@PathVariable Long id) {
    ...
    @GetMapping
    public ResponseEntity<List<TypeUsersResponsedtos>> getAll() {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TypeUsersResponsedtos> update(@PathVariable Long id, @RequestBody @Valid  TypeUsersRequestdtos request) {
