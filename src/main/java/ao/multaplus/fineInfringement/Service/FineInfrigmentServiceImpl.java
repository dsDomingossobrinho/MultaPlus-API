...
public class FineInfrigmentServiceImpl implements FineInfrigmentService {
    ...
    public FineInfrigmentServiceImpl(
            FineInfringementRepository fineInfringementRepository,
            FineRepository fineRepository, StatusRepository statusRepository) {
    ...
    public ResponseEntity<List<FineInfringements>> searchInfrigmentsByFine(Long id) {
        List<FineInfringements> fineInfringements = fineInfringementRepository.findByFineId(
                id);
        return ResponseEntity.ok(fineInfringements);
    }

    @Override
    public ResponseEntity<?> savefineinfrigments(Long id,
